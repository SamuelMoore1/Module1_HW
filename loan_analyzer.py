...
print(f'sum loan cost = {sum(loan_costs)}')
...
print(f'averagen loan =  {average_loan}')
...
#    If the present value of the loan is greater than or equal to the cost, then print a message that says the loan is woth the cost to buy it.
...
def present_value(future_value, remaining_months, annual_discount_rate):
    value = future_value / (1 + (annual_discount_rate / 12)) ** remaining_months
    return value
...
i = present_value(new_loan.get("future_value"), new_loan.get("remaining_months"), 0.2)

print(f"The present value of the loan is: {i}")
